...
from ..utils.utilities import IntervalStrategy, has_length
from ..config.configs import CallbackConfigs
...
class TrainerState:
    ...
    is_epoch_progress_bar_enabled: bool = True
...
class TrainerCallback:
    ...
    def on_init_end(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl, **kwargs):
        """
        Event called at the end of the initialization of the [`Trainer`].
        """
        pass

    def on_train_begin(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl, **kwargs):
        """
        Event called at the beginning of training.
        """
        pass

    def on_train_end(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl, **kwargs):
        """
        Event called at the end of training.
        """
        pass

    def on_epoch_begin(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl, **kwargs):
        """
        Event called at the beginning of an epoch.
        """
        pass

    def on_epoch_end(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl, **kwargs):
        """
        Event called at the end of an epoch.
        """
        pass

    def on_step_begin(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl, **kwargs):
        """
    ...
    def on_optimizer_step(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl, **kwargs):
        """
        Event called after the optimizer step but before gradients are zeroed out. Useful for monitoring gradients.
        """
        pass

    def on_substep_end(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl, **kwargs):
        """
        Event called at the end of an substep during gradient accumulation.
        """
        pass

    def on_step_end(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl, **kwargs):
        """
    ...
    def on_evaluate(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl, **kwargs):
        """
    ...
    def on_save(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl, **kwargs):
        """
        Event called after a checkpoint save.
        """
        pass

    def on_log(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl, **kwargs):
        """
        Event called after logging the last logs.
        """
        pass

    def on_prediction_step(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl, **kwargs):
        """
...
class CallbackHandler(TrainerCallback):
    ...
    def on_init_end(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl):
        return self.call_event("on_init_end", args, state, control)

    def on_train_begin(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl):
        control.should_training_stop = False
        return self.call_event("on_train_begin", args, state, control)

    def on_train_end(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl):
        return self.call_event("on_train_end", args, state, control)

    def on_epoch_begin(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl):
        control.should_epoch_stop = False
        return self.call_event("on_epoch_begin", args, state, control)

    def on_epoch_end(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl):
        return self.call_event("on_epoch_end", args, state, control)

    def on_step_begin(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl):
        control.should_log = False
        control.should_evaluate = False
        control.should_save = False
        return self.call_event("on_step_begin", args, state, control)

    def on_optimizer_step(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl):
        return self.call_event("on_optimizer_step", args, state, control)

    def on_substep_end(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl):
        return self.call_event("on_substep_end", args, state, control)

    def on_step_end(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl):
    ...
    def on_save(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl):
        control.should_save = False
        return self.call_event("on_save", args, state, control)

    def on_log(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl, logs):
        control.should_log = False
        return self.call_event("on_log", args, state, control, logs=logs)

    def on_prediction_step(self, args: CallbackConfigs, state: TrainerState, control: TrainerControl):
...
class ProgressCallback(TrainerCallback):
    ...
    def on_step_end(self, args, state, control, **kwargs):
        if state.is_world_process_zero and state.is_epoch_progress_bar_enabled:
...
class EarlyStoppingCallback(TrainerCallback, ExportableState):
    ...
    Args:
        ...
        early_stopping_threshold(`float`, *optional*):
            Use with CallbackConfigs `metric_for_best_model` and `early_stopping_patience` to denote how much the
            specified metric must improve to satisfy early stopping conditions. `

    This callback depends on [`CallbackConfigs`] argument *load_best_model_at_end* functionality to set best_metric
    in [`TrainerState`]. Note that if the [`CallbackConfigs`] argument *save_steps* differs from *eval_steps*, the
